...
function [ex,ey,ez]= VectorE_time_2nd_order(x,y,z,u,v,w,ut,vt,wt,tau,L)
...
[ex] = boundary_mean3(ex,ex,0);
[ey] = boundary_mean3(ey,ey,0);
[ez] = boundary_mean3(ez,ez,0);
